...
class MyTestCase(unittest.TestCase):
    ...
    def test_three(self):
        self.assertEqual(2.5, trump_detector("MEXICAAAAAAAANS GOOOO HOOOMEEEE"))

    def test_four(self):
        self.assertEqual(1.89, trump_detector("America NUUUUUKEEEE Oooobaaaamaaaaa"))

    def test_five(self):
        self.assertEqual(1.56, 
    ...
    def test_something(self):
        ...
        answer = round(sum(reduced) / len(numv), 2)
